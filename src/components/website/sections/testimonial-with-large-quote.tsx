    ...
    <section className={clsx('py-16', className)} {...props}>
      <Container>
        <figure className="text-olive-950 dark:text-white">
          <blockquote className="font-display mx-auto flex max-w-240 flex-col gap-4 text-center text-[2rem]/12 tracking-tight text-pretty *:first:before:content-['“'] *:last:after:content-['”'] sm:text-5xl/16">
            {quote}
          </blockquote>
          <figcaption className="mt-16 flex flex-col items-center">
            ...
            <p className="text-center text-sm/6 text-olive-700 dark:text-olive-400">
              {byline}
            </p>
          </figcaption>
        </figure>
